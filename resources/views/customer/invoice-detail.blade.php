            ...
            <div class="p-8">
                ...
                <div class="flex justify-between items-start mb-8">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-1">{{ __('messages.date') }}: {{ $invoice->created_at->translatedFormat('l, d F Y') }}</p>
                    </div>
                ...
                <div class="border-t border-b border-gray-200 py-6 mb-6">
                    ...
                    <div class="grid grid-cols-2 gap-4 text-sm">
                        ...
                        <div>
                            ...
                            <p class="font-medium text-gray-900">{{ \Carbon\Carbon::parse($invoice->booking->start_date)->translatedFormat('l, d F Y') }}</p>
                        </div>
                        <div>
                            <p class="text-gray-600">{{ __('messages.check_out_date') }}</p>
                            <p class="font-medium text-gray-900">{{ \Carbon\Carbon::parse($invoice->booking->end_date)->translatedFormat('l, d F Y') }}</p>
                        </div>
                        <div>
                ...
                <div class="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
                    <div class="flex items-center">
                        ...
                        <span class="text-green-800 font-medium">{{ __('messages.payment_received_on') }} {{ $invoice->updated_at->translatedFormat('l, d F Y, H:i') }}</span>
                    </div>
                </div>
                @else
